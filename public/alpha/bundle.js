...
var app = (function () {
  ...
  /* src/components/APICaller.svelte generated by Svelte v3.38.2 */
    ...
    const block = {
      c: function create() {
        ...
        attr_dev(
          div,
          'style',
          (div_style_value = `color: ${/*colour*/ ctx[3]}`)
        );
      ...
      p: function update(ctx, [dirty]) {
        ...
        if (
          dirty & /*colour*/ 8 &&
          div_style_value !== (div_style_value = `color: ${/*colour*/ ctx[3]}`)
        ) {
  ...
  function instance$3($$self, $$props, $$invalidate) {
    ...
    Object.keys($$props).forEach((key) => {
      if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$')
        console_1.warn(`<APICaller> was created with unknown prop '${key}'`);
    });
  ...
  class APICaller extends SvelteComponentDev {
    constructor(options) {
      ...
      if (/*description*/ ctx[1] === undefined && !('description' in props)) {
        console_1.warn(
          "<APICaller> was created without expected prop 'description'"
        );
      }
    ...
    get name() {
      throw new Error(
        "<APICaller>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      );
    }

    set name(value) {
      throw new Error(
        "<APICaller>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      );
    }
  ...
  var getUser = async () => {
    const { emailHash } = get_store_value(authStore);
  ...
  /* src/components/UserChallenge.svelte generated by Svelte v3.38.2 */
  ...
  function create_fragment$2(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        add_location(h2, file$2, 22, 2, 384);
        attr_dev(label0, 'for', 'email');
        attr_dev(label0, 'placeholder', 'test@test.com');
        add_location(label0, file$2, 23, 2, 410);
        attr_dev(input0, 'id', 'email');
        add_location(input0, file$2, 24, 2, 474);
        attr_dev(label1, 'for', 'pwd');
        add_location(label1, file$2, 25, 2, 518);
        attr_dev(input1, 'id', 'pwd');
        add_location(input1, file$2, 26, 2, 555);
        add_location(button, file$2, 28, 4, 605);
        add_location(div, file$2, 27, 2, 595);
        add_location(main, file$2, 21, 0, 375);
      },
      l: function claim(nodes) {
        throw new Error(
          'options.hydrate only works if the component was compiled with the `hydratable: true` option'
  ...
  function instance$2($$self, $$props, $$invalidate) {
    ...
    const onClick = async () => {
      ...
      authStore.setValues({ email, emailHash, pwd, pwdHash });
    };
    ...
    Object.keys($$props).forEach((key) => {
      if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$')
        console.warn(`<UserChallenge> was created with unknown prop '${key}'`);
    });
    ...
    $$self.$capture_state = () => ({ authStore, hash, email, pwd, onClick });
  ...
  /* src/components/UserState.svelte generated by Svelte v3.38.2 */
  ...
  function create_fragment$1(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        add_location(h2, file$1, 12, 2, 273);
        add_location(tc0, file$1, 15, 6, 318);
        add_location(tc1, file$1, 16, 6, 340);
        add_location(tr0, file$1, 14, 4, 307);
        add_location(tc2, file$1, 19, 6, 382);
        add_location(tc3, file$1, 20, 6, 401);
        add_location(tr1, file$1, 18, 4, 371);
        add_location(tc4, file$1, 23, 6, 447);
        add_location(tc5, file$1, 24, 6, 472);
        add_location(tr2, file$1, 22, 4, 436);
        add_location(tc6, file$1, 27, 6, 512);
        add_location(tc7, file$1, 28, 6, 542);
        add_location(tr3, file$1, 26, 4, 501);
        add_location(tc8, file$1, 31, 6, 586);
        add_location(tc9, file$1, 32, 6, 610);
        add_location(tr4, file$1, 30, 4, 575);
        add_location(tc10, file$1, 35, 6, 656);
        add_location(tc11, file$1, 36, 6, 678);
        add_location(tr5, file$1, 34, 4, 645);
        add_location(table, file$1, 13, 2, 295);
        add_location(main, file$1, 11, 0, 264);
      },
      l: function claim(nodes) {
        throw new Error(
          'options.hydrate only works if the component was compiled with the `hydratable: true` option'
      ...
      p: function update(ctx, [dirty]) {
        ...
        if (dirty & /*emailHash*/ 2) set_data_dev(t8, /*emailHash*/ ctx[1]);
  ...
  function instance$1($$self, $$props, $$invalidate) {
    ...
    component_subscribe($$self, authStore, ($$value) =>
      $$invalidate(6, ($authStore = $$value))
    );
    let { $$slots: slots = {}, $$scope } = $$props;
    ...
    Object.keys($$props).forEach((key) => {
      if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$')
        console.warn(`<UserState> was created with unknown prop '${key}'`);
    });
    ...
    $$self.$$.update = () => {
      ...
      if ($$self.$$.dirty & /*$authStore*/ 64) {
        $$invalidate(1, (emailHash = $authStore.emailHash));
      }
    ...
    return [email, emailHash, pwd, pwdHash, sessionId, state, $authStore];
  }
