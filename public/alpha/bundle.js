...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file, 20, 2, 339);
    			add_location(p, file, 21, 2, 357);
    			add_location(button, file, 22, 2, 380);
    			attr_dev(div, "style", div_style_value = `color: ${/*colour*/ ctx[3]}`);
    			add_location(div, file, 23, 2, 425);
    			add_location(main, file, 19, 0, 330);
    		},
    ...
    class APICaller extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { name: 0, description: 1, fn: 5 });
    ...
    var createSession = () => wrapFetch('/session', {
      method: 'POST',
    });
    ...
    const authStore = genericStore(authState);
    ...
    const createUser = async () => {
      const { email, pwd } = get_store_value(authStore);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$1, 13, 2, 203);
    			attr_dev(label0, "for", "email");
    			add_location(label0, file$1, 14, 2, 229);
    			attr_dev(input0, "id", "email");
    			add_location(input0, file$1, 15, 2, 265);
    			attr_dev(label1, "for", "pwd");
    			add_location(label1, file$1, 16, 2, 309);
    			attr_dev(input1, "id", "pwd");
    			add_location(input1, file$1, 17, 2, 346);
    			add_location(button, file$1, 19, 4, 396);
    			add_location(div, file$1, 18, 2, 386);
    			add_location(main, file$1, 12, 0, 194);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			tr4 = element("tr");
    			tc8 = element("tc");
    			tc8.textContent = "state:";
    			t19 = space();
    			tc9 = element("tc");
    			t20 = text(/*state*/ ctx[4]);
    			add_location(h2, file$2, 11, 2, 220);
    			add_location(tc0, file$2, 14, 6, 265);
    			add_location(tc1, file$2, 15, 6, 287);
    			add_location(tr0, file$2, 13, 4, 254);
    			add_location(tc2, file$2, 18, 6, 329);
    			add_location(tc3, file$2, 19, 6, 348);
    			add_location(tr1, file$2, 17, 4, 318);
    			add_location(tc4, file$2, 22, 6, 387);
    			add_location(tc5, file$2, 23, 6, 412);
    			add_location(tr2, file$2, 21, 4, 376);
    			add_location(tc6, file$2, 26, 6, 452);
    			add_location(tc7, file$2, 27, 6, 482);
    			add_location(tr3, file$2, 25, 4, 441);
    			add_location(tc8, file$2, 29, 6, 521);
    			add_location(tc9, file$2, 30, 6, 543);
    			add_location(tr4, file$2, 28, 9, 510);
    			add_location(table, file$2, 12, 2, 242);
    			add_location(main, file$2, 10, 0, 211);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*state*/ 16) set_data_dev(t20, /*state*/ ctx[4]);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, authStore, $$value => $$invalidate(5, $authStore = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$authStore*/ 32) {
    			 $$invalidate(0, email = $authStore.email);
    		}

    		if ($$self.$$.dirty & /*$authStore*/ 32) {
    			 $$invalidate(1, id = $authStore.id);
    		}
    		...
    		if ($$self.$$.dirty & /*$authStore*/ 32) {
    			 $$invalidate(4, state = $authStore.state);
    		}
    	};

    	return [email, id, pwd, pwdHash, state, $authStore];
    }
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 8, 2, 259);
    			add_location(main, file$3, 7, 0, 250);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
